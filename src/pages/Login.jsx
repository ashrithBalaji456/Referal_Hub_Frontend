...
const Login = ({ onLoginSuccess, onNavigateToRegister, onNavigateToForgotPassword }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const { accessToken, username: loggedUser, email } = response.data;
      ...
      <div className="w-full max-w-md bg-slate-900/60 border border-slate-800/80 backdrop-blur-xl p-8 rounded-2xl shadow-2xl animate-slide-in relative z-10">
        <div className="text-center mb-8">
          ...
          <p className="text-slate-400 mt-2 text-sm">
            Sign in to manage your automated recruiter outreach
          </p>
        </div>
          ...
          <div>
            <div className="flex justify-between items-center mb-2">
              ...
              <button
                ...
                className="text-xs text-purple-400 hover:text-purple-300 font-semibold focus:outline-none transition"
              >
                Forgot Password?
              </button>
            </div>
        ...
        <div className="mt-8 text-center border-t border-slate-800/80 pt-6">
          <p className="text-slate-400 text-sm">
            ...
            <button
              ...
              className="text-purple-400 hover:text-purple-300 font-semibold focus:outline-none transition"
            >
              Sign Up
            </button>
          </p>
